...
const nyoutube = ('®  Gilzz')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                zens.sendMessage(m.chat, { image: { url: 'https://Lets-To-Web-Gilzz.agilganzz1.repl.co' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://Lets-To-Web-Gilzz.agilganzz1.repl.co\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n chat nomor berikut : wa.me/6285857537269\n\n_Terima kasih_` }, { quoted: m })
            }
            break 
            case 'chat': {
